      ...
      <div class="navbar-container content">
               ...
               <ul class="nav navbar-nav" style="display:none;">
                  <li class="nav-item d-none d-lg-block">
                     ...
                     <div class="bookmark-input search-input">
                        ...
                        <input class="form-control input" type="text" placeholder="Explore Turia..." tabindex="0" data-search="starter-list" />
         ...
         <ul class="nav navbar-nav float-right">
            ...
            <!-- <li class="nav-item nav-search">
               ...
               <div class="search-input">
                  ...
                  <input class="input" type="text" placeholder="Explore Turia..." tabindex="-1" data-search="starter-list" />
         ...
         <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
               ...
               <span><img class="round" src="{{userimage()}}" alt="avatar" height="40" width="40" /></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
               <a class="dropdown-item" href="{{route('profile.show',auth()->user()->id ?? '')}}"><i class="feather icon-user"></i> @lang('messages.Navigation.Profile')</a>
