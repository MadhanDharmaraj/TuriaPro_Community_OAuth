...
class CreateExpenseItemsTable extends Migration
{
    ...
    public function up()
    {   
        Schema::connection($this->connection)->create('expense_items', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('organization_id');
            $table->foreign('organization_id')->references('id')->on('organizations')->onDelete('cascade');

            $table->unsignedBigInteger('espense_id');
            $table->foreign('espense_id')->references('id')->on('espenses')->onDelete('cascade');

            $table->unsignedBigInteger('goods_and_service_id')->comment('value from goods and services table');
            ...
            $table->index(['organization_id','espense_id']);
